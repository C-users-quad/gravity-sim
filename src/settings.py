...
# general game values
N = 25_000 # num orbital particles
...
MAX_PHYSICS_UPDATES = 1 # per frame
MAX_ACCUMULATOR = 0.25 # max frames calculated during interpolation
